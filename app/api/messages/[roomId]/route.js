...
//   if (!roomId) {
//     return new Response(JSON.stringify({ success: false, error: "Invalid roomId" }), { status: 400 });
//   }
...
//   } catch {
//     return new Response(JSON.stringify({ success: false, error: "Error fetching messages" }), { status: 500 });
//   }
// }
import dbConnect from "@/lib/config/db";
import Message from "@/lib/models/Message";
