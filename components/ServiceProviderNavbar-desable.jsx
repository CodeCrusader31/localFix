      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/requests" className="text-gray-600 hover:text-blue-500 px-3 py-2 rounded-md text-md font-medium transition-colors duration-200">
              Service Requests
            </Link>
            <Link href="/dashboard" className="text-gray-600 hover:text-blue-500 px-3 py-2 rounded-md text-md font-medium transition-colors duration-200">
              Dashboard
            </Link>
